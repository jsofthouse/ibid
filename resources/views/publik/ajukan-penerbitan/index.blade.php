            ...
            <fieldset class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required
                           class="w-full rounded border border-line bg-card px-3 py-2 text-sm">
                    @error('nama')
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="2"
                              class="w-full rounded border border-line bg-card px-3 py-2 text-sm">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="text-sm text-red-700 mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <fieldset class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="sinopsis" id="sinopsis" rows="4"
                              class="w-full rounded border border-line bg-card px-3 py-2 text-sm">{{ old('sinopsis') }}</textarea>
                    @error('sinopsis')
                        <p class="text-sm text-red-700 mt-1">{{ $message }}</p>
                    @enderror
                </div>
